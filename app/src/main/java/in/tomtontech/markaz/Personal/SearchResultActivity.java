    ...
    public class SearchAsync extends AsyncTask<String, Void, String> {
            ...
            if (result.equalsIgnoreCase("failed")) {
                ...
                try {
                    ...
                    if (len == 0) {
                        ...
                        Toast.makeText(ctx, "search Successfull", Toast.LENGTH_SHORT).show();
                        ...
                        Log.v("name", "value:" + Arrays.toString(name));
                        Log.v("cat", "value:" + searchResult_category);
                        Log.v("id", "value:" + Arrays.toString(id));
                        Log.v("label", "value:" + Arrays.toString(label));
                        CustomList_searchResult customList_searchResult = new CustomList_searchResult(avt, name, label, searchResult_category);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                String data = URLEncoder.encode(searchResult_category, "UTF-8") + "=" + URLEncoder.encode(searchResult_key, "UTF-8");
