...
public class AddPhotoAsync extends AsyncTask<String, Void, String> {
  ...
  public AddPhotoAsync(Context ctx) {
    this.ctx = ctx;
  }
  ...
  protected String doInBackground(String... strings) {
    try {
      String data = URLEncoder.encode("PhotoName", "UTF-8") + "=" + URLEncoder
          .encode(strings[0], "UTF-8") + "&" +
          URLEncoder.encode("PhotoId", "UTF-8") + "=" + URLEncoder
          .encode(strings[2], "UTF-8") + "&" +
          URLEncoder.encode("PhotoString", "UTF-8") + "=" + URLEncoder
          .encode(strings[3], "UTF-8") + "&" +
          URLEncoder.encode("PhotoDesc", "UTF-8") + "=" + URLEncoder.encode(strings[1], "UTF-8");
      String fileName = "php_insertPhotoDetails.php";
